...
#define OLED_SPI_RST_PIN                GPIO_PIN_13
#define OLED_SPI_RST_CLK_ENABLE()       do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PG口时钟使能 */

#define OLED_SPI_CS_PORT                GPIOG
#define OLED_SPI_CS_PIN                 GPIO_PIN_11
#define OLED_SPI_CS_CLK_ENABLE()        do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define OLED_SPI_RS_PORT                GPIOG
#define OLED_SPI_RS_PIN                 GPIO_PIN_15
#define OLED_SPI_RS_CLK_ENABLE()        do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PD口时钟使能 */

#define OLED_SPI_SCLK_PORT              GPIOG
#define OLED_SPI_SCLK_PIN               GPIO_PIN_10
#define OLED_SPI_SCLK_CLK_ENABLE()      do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PC口时钟使能 */

#define OLED_SPI_SDIN_PORT              GPIOG
#define OLED_SPI_SDIN_PIN               GPIO_PIN_14
#define OLED_SPI_SDIN_CLK_ENABLE()      do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PC口时钟使能 */
